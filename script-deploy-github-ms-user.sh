...
# =============================================================================
# Uso:
#   ./script-deploy-github-ms-user.sh up             # Incrementa patch no POM + Deploy Docker
#   ./script-deploy-github-ms-user.sh 1.0.5 up       # Define versão explícita + Deploy Docker
#   ./script-deploy-github-ms-user.sh                # Incrementa patch no POM + GitHub Registry apenas
#   ./script-deploy-github-ms-user.sh --current up   # Mantém versão atual do POM + Deploy Docker
# =============================================================================
