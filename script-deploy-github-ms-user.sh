...
# Build Maven, Push (Commit SHA + latest) e Deploy Local do ms-user (Spring Boot)
#
# Uso:
#   ./script-deploy-github-ms-user.sh up       # Commit, Push GHCR + Sobe no Docker Local
#   ./script-deploy-github-ms-user.sh          # Commit, Push GHCR (sem subir local)
# =============================================================================
