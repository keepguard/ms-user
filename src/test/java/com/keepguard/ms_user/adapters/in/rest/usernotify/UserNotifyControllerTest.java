...
class UserNotifyControllerTest {
    ...
    void shouldGetByUserIdSuccessfully() throws Exception {
        ...
        when(mapper.toGetByUserIdQuery(userId, companyId)).thenReturn(UserNotifyTestBuilder.builder().buildGetByUserIdQuery());
    ...
    void shouldGetByCodeUserSuccessfully() throws Exception {
        ...
        when(mapper.toGetByCodeUserQuery(codeUser, companyId)).thenReturn(UserNotifyTestBuilder.builder().buildGetByCodeUserQuery());
    ...
    void shouldPatchByUserIdSuccessfully() throws Exception {
        ...
        when(mapper.toPatchCommand(eq(userId), any(), eq(companyId), any())).thenReturn(UserNotifyTestBuilder.builder().buildPatchCommand());
    ...
    void shouldPatchByCodeUserSuccessfully() throws Exception {
        ...
        when(mapper.toPatchCommand(any(), eq(codeUser), eq(companyId), any())).thenReturn(UserNotifyTestBuilder.builder().buildPatchCommand());
